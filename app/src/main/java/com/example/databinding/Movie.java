...
public class Movie {
    ...
    public static Movie[] ITEMS = new Movie[]{
            new Movie("https://pic.yify-torrent.org/2006/32233/7c72074e27054d6b8fff4d68f7868916.png", "A Scanner Darkly is a 2006 American adult animated science fiction thriller film directed by Richard Linklater based on the novel of the same name by Philip K. Dick."),
            new Movie("http://vignette3.wikia.nocookie.net/marvelmovies/images/c/cf/X-men_team.png/revision/latest?cb=20110311174912", "X-Men: The Last Stand (also known as X-Men 3 or X3)[5] is a 2006 American superhero film, based on the X-Men superhero team introduced in Marvel Comics. "),
            new Movie("https://thenypost.files.wordpress.com/2014/11/tv_odyssey2.jpg", "2001: A Space Odyssey is a 1968 epic science fiction film produced and directed by Stanley Kubrick. The screenplay, written by Kubrick and Arthur C. Clarke, was partially inspired by Clarke's short story \"The Sentinel\". Clarke concurrently wrote the novel 2001: A Space Odyssey, published soon after the film was released. "),
            new Movie("http://www.dan-dare.org/FreeFun/Images/Archive/Spider-Man2Wallpaper1024.jpg", "Spider-Man 2 is a 2004 American superhero film directed by Sam Raimi and written by Alvin Sargent from a story by Alfred Gough, Miles Millar, and Michael Chabon. The sequel to the 2002 film Spider-Man, it is the second film in Raimi's Spider-Man film trilogy based on the fictional Marvel Comics character of the same name."),
            new Movie("https://upload.wikimedia.org/wikipedia/en/2/20/Batman_v_Superman_poster.jpg", "Batman v Superman: Dawn of Justice is an upcoming American superhero film featuring the DC Comics characters Batman and Superman, distributed by Warner Bros. Pictures. It is intended to be the follow-up to 2013's Man of Steel and the second installment in the DC Extended Universe. "),
